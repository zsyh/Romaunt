...
public class TitleBar extends RelativeLayout implements OnClickListener,
    ...
    protected TitleBarButton leftButton;
    protected TitleBarButton rightButton;
    ...
    private void initView() {
        ...
        leftParam = new LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT,
        ...
        rightParam = new LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT,
                RelativeLayout.LayoutParams.MATCH_PARENT);
        if (rightText == null) {
        ...
        titleParam = new LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT,
                RelativeLayout.LayoutParams.MATCH_PARENT);
